...
function HomePage() {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      <div className="bg-cover relative w-full h-full ">
        <img
        ...
        <div className="absolute flex flex-col justify-end top-0 h-screen  w-full">
          ...
          <h1 className="text-4xl font-semibold font-sans">Find a trip</h1>
          <h2 className="text-3xl absolute right-4 top-6 ">
            {panel ? <IoIosArrowDown onClick={() => setpanel(false)} /> : "" }
          </h2>
          <form onSubmit={(e) => submitHandler(e)} className="mt-4 relative">
            <div className="absolute top-7 left-3 rounded-full bg-gray-500 w-1 h-20 bg-black"></div>
            <input
              value={pickUp}
              onClick={() => setpanel(true)}
              onChange={(e) => setPickUp(e.target.value)}
              className="bg-gray-200 mb-7 rounded-xl px-12 py-3 border w-full text-xl placeholder:text-lg"
              required
              type="email"
